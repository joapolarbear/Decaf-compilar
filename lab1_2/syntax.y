...
/* declared tokens */
%token <a> INT FLOAT ID  BOOL STRING 
%token <a> SEMI COMMA 
...
%token <a> STRUCT RETURN IF ELSE WHILE CLASS EXTENDS FOR BREAK

%token <a> NEW NULL THIS VOID STATIC PRINT READINTEGER READLINE INSTANCEOF COMMENT
